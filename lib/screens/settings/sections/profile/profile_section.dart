...
import 'package:app/screens/settings/sections/profile/sections/sensitivity_drop_down/sensitivity_drop_down.dart';
import 'package:app/screens/settings/sections/profile/sections/side_list/side_list.dart';
...
class ProfileSection extends StatelessWidget {
  ...
  final Function(DiceDefinitionDetailModel model, int sideIndex) changeAnimation;
    ...
    return SettingsPage(
      children: [
        ...
        SideList(
          ...
          changeAnimation: (sideIndex) => changeAnimation(profile, sideIndex),
        )
      ],
    );
  }
