...
class UpdateSideDefinitionVectorDialog extends StatefulWidget {
  ...
  const UpdateSideDefinitionVectorDialog({
    super.key, 
    required this.side,
  ...
  @override
  State<UpdateSideDefinitionVectorDialog> createState() => _UpdateSideDefinitionVectorDialogState();
}

class _UpdateSideDefinitionVectorDialogState extends State<UpdateSideDefinitionVectorDialog>{
